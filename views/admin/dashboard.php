                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <?php if (!empty($request['link_1'])) : ?>
                        <a target="_blank" href="<?php echo htmlentities($request['link_1']); ?>"><strong>Link Documents:</strong> <?php echo htmlentities($request['link_1']); ?></a>
                      <?php else : ?>

                      <?php endif; ?>

                      <?php if (!empty($request['link_2'])) : ?>
                        <a target="_blank" href="<?php echo htmlentities($request['link_2']); ?>"><strong>Link Documents:</strong> <?php echo htmlentities($request['link_2']); ?></a>
                      <?php else : ?>

                      <?php endif; ?>

                      <?php if (!empty($request['link_3'])) : ?>
                        <a target="_blank" href="<?php echo htmlentities($request['link_3']); ?>"><strong>Link Documents:</strong> <?php echo htmlentities($request['link_3']); ?></a>
                      <?php else : ?>
                      ...
                      <form action="../../controllers/update_request.php" method="POST">
                        <div class="mb-3">
                          ...
                          <textarea class="form-control" id="adminComment" name="admin_comment" rows="3" placeholder="comments" required></textarea>
                        </div>
